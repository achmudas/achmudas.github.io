...
export class PostsService {
  ...
  POSTS : Post[] = [
    ...
    {id: 3, type: "daily", title: "January 19 | Work", text: "1. aaamazing post with detailed text 3 long 2. text to that wouldn't ```javascript fill long text to that wouldn't fill``` long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill long text to that wouldn't fill"},
